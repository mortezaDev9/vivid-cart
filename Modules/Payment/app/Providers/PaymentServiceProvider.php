...
use Modules\Payment\Gateways\ZarinPal;
...
class PaymentServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(PaymentGatewayInterface::class, fn() => new ZarinPal(config('payment.zarinpal.merchant_id')));

        Gate::define('handle', function (User $user, Order $order) {
